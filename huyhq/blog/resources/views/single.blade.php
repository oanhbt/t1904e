...
<div class="site-cover site-cover-sm same-height overlay single-page" style="background-image: url('{{asset($post->cover)}}');"> <!-- thêm asset để lấy ra đường dẫn tương đối đến thư mục chưa ảnh -->
    <div class="container">
    ...
    <div class="container">
        <div class="row blog-entries element-anumate">
            <div class="col-md-12 col-lg-8 main-content">
                {!!$post->content!!} <!-- Thêm !! bảo { để đảm bảo khi refresh k bị hủy các thẻ html  -->
