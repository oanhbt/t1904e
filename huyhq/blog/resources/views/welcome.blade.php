...
<div class="site-section bg-light">
    <div class="container">
        <div class="row align-items-stretch retro-layout-2">
            <div class="col-md-4">
                <a href="single.html/{{$lsLastestPost[0]->id}}" class="h-entry mb-30 v-height gradient" style="background-image: url('{{$lsLastestPost[0]->cover}}');">
            ...
            <div class="col-md-4">
                ...
                <a href="single.html" class="h-entry v-height gradient" style="background-image: url('images/{{$lsLastestPost[4]->cover}}');">

                    <div class="text">
                        <h2>{{$lsLastestPost[4]->title}}</h2>
                        <span class="date">{{$lsLastestPost[4]->created_at}}9</span>
                    </div>
                </a>
            </div>
        </div>
                ...
                <div class="entry2">
                    ...
                    <div class="excerpt">
                        ...
                        <div class="post-meta align-items-center text-left clearfix">
                            ...
                            <span>&nbsp;-&nbsp; {{date('d/M/Y hh:mm:ss', strtotime($post->created_at)) }}</span>
                        </div>
    ...
    <div class="container">
        ...
        <div class="row align-items-stretch retro-layout">
            ...
            <div class="col-md-6 order-md-2">
                <a href="single.html/{{$category->posts()->orderBy('created_at','DESC')->first()->id}}" class="hentry img-2 v-height mb30 gradient" style="background-image: url('images/img_4.jpg');">
